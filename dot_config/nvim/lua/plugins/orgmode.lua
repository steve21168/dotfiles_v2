return {
  { 'akinsho/org-bullets.nvim', lazy = true },
  {
    ...
    config = function()
      ...
      orgmode.setup({
        org_agenda_files = {'~/Library/Mobile Documents/com~apple~CloudDocs/notes/org/*' },
        org_default_notes_file = '~/Library/Mobile Documents/com~apple~CloudDocs/notes/org/misc.org',
